...
const Attachments = React.memo(
  props => {
    ...
    const addLiiteUrl = file =>
      file.uuid
        ? Object.assign({}, file, { url: `/liitteet/${file.uuid}/raw`, apiBaseUrl: props.apiBaseUrl })
        : file;
              ...
              >
                <LiiteListItem>
                  ...
                  <Checkbox
                    title={
                      liite.salainen
                        ? props.attachmentSecretUnselect
                        : props.attachmentSecretSelect
                    }
                  >
                    <input
                      type="checkbox"
    ...
    return (
      <React.Fragment>
        ...
        {fileError && <Error>{props.attachmentError}</Error>}
        ...
        >
          ...
          <DialogContent>
            ...
            />
            <Error>
              {nameMissing && props.attachmentErrorName}
            </Error>
          </DialogContent>
          <DialogActions>
...
Attachments.propTypes = {
  ...
  attachmentDownload: PropTypes.string,
  attachmentSecretUnselect: PropTypes.string,
  attachmentSecretSelect: PropTypes.string,
  attachmentRemove: PropTypes.string,
  attachmentSecret: PropTypes.string,
  attachmentNone: PropTypes.string,
  attachmentError: PropTypes.string,
  attachmentName: PropTypes.string,
  attachmentErrorName: PropTypes.string,
  ok: PropTypes.string,
