...
var Attachments = React.memo(function (props) {
    ...
    if (attachments && attachments.length > 0) return attachments.map(function (liite) {
      ...
      if ((liite.tiedostoId || liite.uuid) && !liite.removed && (!props.placement || liite.paikka === props.placement)) {
        return React.createElement(React.Fragment, {
          ...
          title: props.attachmentDownload,
          onClick: downloadFileFn(addLiiteUrl(liite)),
          className: "ml-2"
        }, React.createElement(FaDownload, null)), React.createElement(Checkbox, {
          title: liite.salainen ? props.attachmentSecretUnselect : props.attachmentSecretSelect
    ...
    if (attachments && attachments.length > 0) return attachments.map(function (liite) {
      if ((liite.tiedostoId || liite.uuid) && !liite.removed && (!props.placement || liite.paikka === props.placement)) {
        return React.createElement(React.Fragment, {
          ...
          title: liite.salainen ? props.attachmentSecret : ""
        }, liite.salainen && React.createElement(FaLock, null))));
      } else return null;
    });else {
      return React.createElement("p", null, React.createElement("i", null, props.attachmentNone));
    }
  };
  ...
  return React.createElement(React.Fragment, null, !props.showListOnly && !props.isReadOnly && React.createElement(Attachment, {
  ...
  }), fileError && React.createElement(Error, null, props.attachmentError), !props.listHidden && !props.isReadOnly && React.createElement(LiiteList, null), !props.listHidden && props.isReadOnly && React.createElement(LiiteListReadOnly, null), React.createElement(Dialog, {
    ...
    id: "name-dialog"
  }, props.attachmentName), React.createElement(DialogContent, null, React.createElement(Input, {
  ...
  }), React.createElement(Error, null, nameMissing && props.attachmentErrorName)), React.createElement(DialogActions, null, React.createElement(Button, {
    onClick: addAttachment,
    color: "primary",
    variant: "contained"
  }, props.ok), React.createElement(Button, {
